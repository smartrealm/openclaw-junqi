...
- macOS Apple Silicon 本地测试 DMG 已随 BUG-07、消息操作栏和当前工作区中的智能体活动视图重新生成，SHA-256 为 `31c1278215fe9671accc62b1e361ba4af9b831ffd767e0880b1e82a2a2704f34`，大小为 8000178 字节。`hdiutil verify`、只读挂载、ARM64 架构和 ad-hoc 深度签名严格核验通过；应用资源已密封，内嵌协作插件为 `0.5.7`、schema 15、归档摘要为 `3b45e38d6a56f99e665018ee06d2c51ac0c08ea62fe2a1b15e4b80fe14874805`，钉钉插件为 `0.1.0`、33 个工具，两份 metadata 和归档均与仓库受控资源逐字节一致。
