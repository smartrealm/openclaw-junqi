...
- 先前 macOS Apple Silicon 本地测试 DMG 构建成功，`hdiutil verify` 通过，SHA-256 为 `7d6acea3f70bf067a8cc1ed130d4b6358e1f2da9720b5a5395e540bcc73598b4`。只读挂载确认应用内归档及 metadata 均为协作插件 `0.5.5`、schema 15、上述固定归档哈希；该 DMG 早于本轮 Rust 制品清理修改，不能作为当前源码的安装验收证据。
