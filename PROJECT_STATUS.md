...
- 已基于当前工作区重新构建并校验 macOS arm64 DMG 验收包：`src-tauri/target/release/bundle/dmg/JunQi Desktop_2.2.10_aarch64.dmg`。`hdiutil verify` 通过，文件大小为 8744785 字节，SHA-256 为 `f3ff7d304061722ca57b6299f1dcdd5411cefd4c98a15938c76f14bc725d0ec4`。该包未正式签名或公证；本轮尚未重新执行安装后的真机走查。
