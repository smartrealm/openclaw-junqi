...
- 已基于当前 `main` 生成 macOS Apple Silicon 本地测试 DMG。应用与构建版本均为 `3.2.1`，二进制为 ARM64；`hdiutil verify` 通过，DMG SHA-256 为 `7401540fd3c934506d664e2916b7611fc321c09a4c581a63d1bb635f3b2145c2`。
- DMG 内嵌协作插件版本为 `0.5.4`、schema 15，归档 SHA-256 为 `458a2ca1c457db32e90e7cfcb4326bc26595dd33445b03bbb53e9772375f132c`，与仓库受控资源一致。
...
3. 安装当前 ARM64 本地测试 DMG，复测 schema 14 到 15 恢复、智能体办公室和 Gateway 权限闭环；正式分发前另行完成 Developer ID 签名、公证与 updater 签名。
