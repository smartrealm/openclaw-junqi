...
const PUBLIC_ERROR_MESSAGES = {
  ...
  DWS_APPROVAL_PREFLIGHT_INVALID: "Target approval preflight input is invalid",
  DWS_ARGUMENT_CONSTRAINT: "DWS arguments violate a cross-parameter constraint",
  DWS_ARGUMENT_ENUM: "A DWS argument is outside the allowed values",
  DWS_ARGUMENT_FORMAT: "A DWS argument has an invalid format",
  ...
  DWS_EVENT_CONFIGURATION_INVALID: "DWS event configuration is invalid",
  DWS_EVENT_PROCESS_FAILED: "DWS event consumer failed",
  DWS_EVENT_PROTOCOL_INVALID: "DWS event stream protocol is invalid",
  DWS_EVENT_STARTUP_TIMEOUT: "DWS event consumer startup timed out",
  DWS_EVENT_STOP_TIMEOUT: "DWS event consumer shutdown timed out",
  DWS_INVALID_JSON: "DWS returned invalid JSON output",
  DWS_INPUT_INVALID: "DWS standard input is invalid",
  DWS_INPUT_LIMIT: "DWS standard input exceeded the configured limit",
  DWS_MINUTES_PREFLIGHT_INVALID: "Target Minutes preflight input is invalid",
  ...
  DWS_REPORT_PREFLIGHT_INVALID: "Target report preflight input is invalid",
  DWS_REPORT_PREFLIGHT_RESULT_INVALID: "Target report preflight result is invalid",
  DWS_REPORT_PREFLIGHT_TEMPLATE_UNRESOLVED: "Target report preflight template is unresolved",
  DWS_RESULT_INVALID: "DWS returned an invalid result envelope",
  ...
  DWS_SENSITIVE_PREFLIGHT_INVALID: "Target sensitive read preflight input is invalid",
  ...
  DWS_WRITE_APPROVAL_UNAVAILABLE: "DWS write approval summary is unavailable",
  DWS_WRITE_RECONCILIATION_UNAVAILABLE: "DWS write reconciliation is unavailable",
} as const;
