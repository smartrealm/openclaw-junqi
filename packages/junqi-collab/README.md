...
Current package baseline: plugin `0.5.9`, SQLite schema `15`, OpenClaw
`>=2026.8.1`.
...
npm run collab:pack
openclaw plugins install --force --pin npm-pack:packages/junqi-collab/dist/junqi-openclaw-collaboration-0.5.9.tgz
