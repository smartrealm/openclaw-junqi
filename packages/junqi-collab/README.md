...
Current package baseline: plugin `0.5.6`, SQLite schema `15`, OpenClaw
`>=2026.7.1`.
...
npm run collab:pack
openclaw plugins install --force --pin npm-pack:packages/junqi-collab/dist/junqi-openclaw-collaboration-0.5.6.tgz
