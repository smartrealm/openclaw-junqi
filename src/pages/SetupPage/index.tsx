...
export function SetupPage() {
  ...
  const screen = (() => {
    switch (setupStep) {
      ...
      case "storage": return <StorageSetupStep activeStage={flow.presentation.stage} logs={sharedLogs} onReady={flow.completeStorageSetup} onBack={flow.goBack} onRecoveryBack={flow.leaveRuntimeRecovery} onRepairNodeRuntime={flow.repairNodeRuntimeForStorage} forceConfigure={flow.forceStorageSelection} />;
