...
} from '@/runtime/CollaborationChatRuntime';
import {
...
const MessageInput = lazy(() => import('@/components/Chat/MessageInput').then((m) => ({ default: m.MessageInput })));
const SessionEventCard = lazy(() => import('@/components/Chat/ResultCards').then((m) => ({ default: m.SessionEventCard })));
const ThinkingBubble = lazy(() => import('@/components/Chat/ThinkingBubble').then((m) => ({ default: m.ThinkingBubble })));
const ToolCallBubble = lazy(() => import('@/components/Chat/ToolCallBubble').then((m) => ({ default: m.ToolCallBubble })));
const TypingIndicator = lazy(() => import('@/components/Chat/TypingIndicator').then((m) => ({ default: m.TypingIndicator })));
const QuickReplyBar = lazy(() => import('@/components/Chat/QuickReplyBar').then((m) => ({ default: m.QuickReplyBar })));
const WorkshopEventCard = lazy(() => import('@/components/Chat/ResultCards').then((m) => ({ default: m.WorkshopEventCard })));
