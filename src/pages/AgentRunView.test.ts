...
test('task terminal does not claim local provider quotas outside OpenClaw', () => {
  assert.doesNotMatch(source, /useUsageSnapshot|read_usage_snapshot|InlineUsageWindow|usageSnapshot/);
});
