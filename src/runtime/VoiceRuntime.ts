...
import { SentenceSplitter, sanitizeSpeechText } from '@/services/voice/sentenceSplitter';
import { GatewayTtsSpeechOutput, type VoiceSpeechOutput } from '@/services/voice/GatewayTtsSpeechOutput';
import {
 ...
 * 桌面语音输出协调器。
 *
 * 语音由当前 OpenClaw Gateway 合成，WebView 只播放返回的音频，
 * 不自行选择本地语音引擎。
 */
