...
export const panels = {
  ...
  agentMissingMdBanner: {
    ...
    marginBottom: 10,
    padding: "10px 14px",
    background: "rgb(var(--aegis-warning) / 0.06)",
    border: "1px solid rgb(var(--aegis-warning) / 0.2)",
    borderRadius: 8,
  ...
  railAttentionBadge: {
    ...
    justifyContent: "center",
    borderRadius: 999,
    background: "rgb(var(--aegis-warning))",
    color: "#fff",
    fontSize: 10,
    fontWeight: 700,
    lineHeight: 1,
  ...
  fileChip: {
    ...
    border: "1px solid color-mix(in srgb, rgb(var(--aegis-primary)) 30%, transparent)",
    borderRadius: 6,
    fontSize: 12.5,
    fontWeight: 500,
    color: "rgb(var(--aegis-primary))",
  ...
  mentionOptionName: { fontSize: 13, fontWeight: 500, color: "rgb(var(--aegis-text))", flexShrink: 0 },
  mentionOptionDir: {
    fontSize: 11.5,
  ...
  fileSearchDialogBackdrop: {
    ...
    justifyContent: "center",
    paddingTop: "18vh",
    background: "color-mix(in srgb, var(--aegis-bg) 38%, transparent)",
  },
  fileSearchDialog: {
  ...
  fileTreeCreateInput: {
    ...
    fontFamily: "var(--font-ui)",
    color: "rgb(var(--aegis-text))",
    background: "var(--bg-input, var(--aegis-surface))",
  ...
  imageAttachmentRemove: {
    ...
    height: 16,
    borderRadius: "50%",
    background: "rgb(var(--aegis-text-muted))",
    border: "none",
    color: "var(--bg)",
    fontSize: 10,
    lineHeight: "16px",
  ...
  hooksPanelHint: { fontSize: 11, color: "rgb(var(--aegis-text-dim))", marginTop: 3, lineHeight: 1.5 },
  hooksPanelCard: {
    border: "1px solid var(--aegis-border)",
    borderRadius: 8,
    padding: "10px 14px",
  ...
  hooksPanelVersionLow: { color: "rgb(var(--aegis-warning))" },
  hooksPanelErrorRow: {
    display: "flex",
    alignItems: "flex-start",
    gap: 8,
  ...
  thanksName: { ...thanksNameBase, color: "rgb(var(--aegis-text))" },
  thanksNameCopied: { ...thanksNameBase, color: "rgb(var(--aegis-primary))" },
