...
export const layout = {
  ...
  sidebar: {
    width: "var(--aegis-sidebar-expanded)",
    flexShrink: 0,
  ...
  sidebarBrandBadge: {
    ...
    fontSize: "var(--aegis-fs-lg)",
    fontWeight: 800,
    letterSpacing: 0.6,
    paddingBottom: 4,
  },
  sidebarBrandTitle: {
    fontSize: "var(--aegis-fs-xl)",
    fontWeight: 700,
    color: "rgb(var(--aegis-text))",
    lineHeight: 1.2,
  },
  sidebarBrandMeta: { marginTop: 3, fontSize: "var(--aegis-fs-sm)", color: "rgb(var(--aegis-text-muted))" },
  sidebarNav: { display: "flex", flexDirection: "column", gap: 6 },
  sidebarSectionTitle: {
    fontSize: "var(--aegis-fs-xs)",
    fontWeight: 700,
  ...
  primaryActionBtn: {
    ...
    border: "1px solid var(--aegis-border)",
    borderRadius: 10,
    fontSize: "var(--aegis-fs-base)",
    fontWeight: 700,
    cursor: "pointer",
    boxShadow: "var(--shadow-xs)",
  },
  projectSectionHeader: { padding: "14px 22px 6px", flexShrink: 0 },
  projectSectionTitle: { fontSize: "var(--aegis-fs-md)", fontWeight: 700, color: "rgb(var(--aegis-text))" },
  projectSectionCaption: { marginTop: 4, fontSize: "var(--aegis-fs-sm)", color: "rgb(var(--aegis-text-muted))" },
