                ...
                {branches.map((branch) => {
                  ...
                  return (
                    <button
                      ...
                      type="button"
                      onClick={() => !branch.active && capabilities.branchSwitch && confirmSwitch(branch.leafEntryId)}
                      disabled={branch.active || switchingLeafEntryId !== null || !capabilities.branchSwitch}
                      className={clsx(
