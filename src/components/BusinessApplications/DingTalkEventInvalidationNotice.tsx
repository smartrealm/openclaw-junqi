...
export function DingTalkEventInvalidationNotice({
  ...
  return (
    <div className="rounded-md border border-aegis-primary/25 bg-aegis-primary/[0.05] px-2.5 py-2" role="status">
      <div className="text-[10px] font-medium text-aegis-text-secondary">{t('businessApplications.events.latestSignal')}</div>
      <p className="mt-0.5 break-words text-[9.5px] leading-4 text-aegis-text-dim">
