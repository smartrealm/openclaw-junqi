...
/**
 * Keep the collaboration projection available outside Chat. The plugin owns
 * status and history; this component only hydrates the read projection used by
 * Activity Center and the Chat history drawer.
 */
