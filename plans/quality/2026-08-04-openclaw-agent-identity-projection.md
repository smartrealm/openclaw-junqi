...
- [x] Route assistant name and configured marker presentation through the official response, with a localized
  generic label rather than a locally derived identity on failure.
- [x] Add Gateway-client and presentation contract regressions.
