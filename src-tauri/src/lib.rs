...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::storage::inspect_runtime_recovery_port_owner,
            commands::storage::rollback_runtime_reconfiguration,
            commands::storage::terminate_runtime_recovery_port_owner_and_retry,
            ...
            commands::setup_diagnostics::get_setup_diagnostics_directory,
            commands::setup_diagnostics::export_setup_diagnostics_bundle,
            // Control UI (Console)
