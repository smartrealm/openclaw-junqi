...
状态：已被 2026-08-10 的官方协议变更取代。`doctor.memory.remHarness` 已从 OpenClaw 主线删除，现行规格见
[`2026-08-10 Gateway 审计协议收敛`](2026-08-10-gateway-audit-protocol-convergence.md)。本文仅保留历史验收背景。
